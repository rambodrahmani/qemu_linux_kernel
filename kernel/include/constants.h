/**
 * File: constants.h
 *       This header contains different constant definitions used in almost all
...
/**
 * Constants for system.cpp and system.S.
 *
 * Available Selectors (flat segmentation model).
 */
...
/**
 * Available Descriptor Privilege Levels.
 */
#define  LEV_USER    3
#define  LEV_SYSTEM  0

/**
 * Available task state segments (TSS).
 */
#define  NUM_TSS  1024
