...
//   ESAME 2019-09-23 )
	...
	carica_gate	TIPO_MEM	a_getnframe	LIV_UTENTE
	carica_gate	TIPO_GPID	a_getpid	LIV_UTENTE
// ( ESAME 2019-09-23
...
debug:
	...
	call salva_stato
// ( ESAME 2019-09-23
	// questa eccezione viene sollevata dopo ogni
	// istruzione, se il TRAP_FLAG e' settato
	movq $1, %rdi
	movq $0, %rsi
	movq %rsp, %rdx
	call c_debug_exception
//   ESAME 2019-09-23 )
	call carica_stato
	iretq
	.cfi_endproc
